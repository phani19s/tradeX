          ...
          <div className="rounded-[28px] border p-6 shadow-xl" style={{ background: "var(--card)", borderColor: "var(--border)" }}>
            ...
            <div className="mt-2 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div className="flex items-center gap-3">
                <svg
                  className="h-10 w-10 text-accent shrink-0 animate-pulse"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2.5"
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="inline-flex h-10 w-10 items-center justify-center rounded-full border text-white shadow-lg transition hover:scale-105 hover:opacity-90 cursor-pointer"
                  style={{
